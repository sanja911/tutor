  ...
  <tbody>
    <?php
    $query = mysql_query ("SELECT * FROM materi_tutor INNER JOIN kelas ON materi.id_tutor = kelas.id_tutor INNER JOIN mapel ON kelas.id_mapel=mapel.id_mapel where materi.id_kelas='$id' and materi.id_tutor='$out2[id_tutor]' order by materi.id_tutor ASC");
      if($query == false){
