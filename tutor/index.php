			...
			<div class="modal-dialog">
    			<div class="modal-content abt-w3l">
							<div class="modal-header">
								...
								<form action="../comp/insert_.php" method="post">
                 ...
                 <div class="col-md-12 col-sm-12 col-xs-12">
                      ...
                      <h4><label>Kuesioner Rekomendasi pemilihan tutor terbaik menggunakan Algoritma Squeezer
					 </label></h4>
						<input type="hidden" value="<?php echo $data['id_user'];?>" name="id_user">
                        <p align=left>Nama : <?php echo $data['nama_lengkap'];?></br></p>
                        <p align=left>Email : <?php echo $data['email'];?></p>
                     </div>
                   </div>
                   ...
                   <thead>
                    <tr>
                    <td width="2%">No</th>
                    <td align="center" width="60%">Pernyataan</th>
                ...
                ?>
          <tr>
            <td><input type="hidden"  name="id_soal[]" value="<?php echo $ar['id']; ?>"><?php echo $ar['id']; ?></td>
            <td><?php echo $ar['pernyataan'];?></td>
            <td align=center valign=bottom> <select id="" name="jawaban[]" class="form-control select2">
            <option value=""></option>
			<?php
				$sql = mysql_query("SELECT * FROM pilihan");
...
<script>
  ...
  <?php
        ...
        $hasil = mysql_query($sql);
        $data  = mysql_fetch_array($hasil);
        $sql1 = mysql_query("select * from angket where id_user='$data[id_user]'");
        if (mysql_num_rows($sql1) == 0) {
?>
 <script>
    $('#myModal').modal('show');
