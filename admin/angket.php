...
<nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
  ...
  <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <ul class="nav menu">
      ...
      <li class="parent "><a data-toggle="collapse" href="#sub-item-1">
          ...
          <li><a class="active" href="angket.php">
  ...
  <thead>
    <tr align="center">
      <th width="2%">No</th>
      <th width="15%">Nama</th>
      <th width="10%">Jawaban SS</th>
      <th width="10%">Jawaban S</th>
      <th width="10%">Jawaban R</th>
      <th width="10%">Jawaban TS</th>
      <th width="10%">Jawaban STS</th>
  ...
  <tbody>
    <?php
    $query = mysql_query ("SELECT * FROM jawaban inner join user ON jawaban.id_user=user.id_user");
      if($query == false){
      ...
      while ($ar = mysql_fetch_array ($query)){
        ?>
          ...
          <tr>
            ...
            <td align="center"><?php echo $ar['nama_lengkap'];?> (<?php echo $ar['id_user'];?>)</td>
            <td align="center"><?php echo $ar['SS'];?></td>
            <td align="center"><?php echo $ar['S'];?></td>
            <td align="center"><?php echo $ar['R'];?></td>
            <td align="center"><?php echo $ar['TS'];?></td>
            <td align="center"><?php echo $ar['STS'];?></td>
...
<div class="col-sm-12">
  ...
  <script type="text/javascript" >
$(function() {
  $("#formkuesioner-- .btn").click(function() {
    $('#formkuesioner--').ajaxloader();
    var kuesfak = $("#optionsRadios1:checked").val();
    var kuespel = $("#optionsRadios2:checked").val();
	var kueskur = $("#optionsRadios3:checked").val();
    var dataString = 'kuesfak='+ kuesfak + '&kuespel=' + kuespel + '&kueskur=' + kueskur;
 
    $.ajax({
    type: "POST",
    url: "proses-kuesioner.php",
    data: dataString,
    success: function(){
		$('#formkuesioner').ajaxloader('hide');
      //$('.success').fadeIn(1000);
	  window.location.reload('vote.php?successkue=1');
    }
    });
